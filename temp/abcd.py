...
class InputForm(wx.Frame):
    ...
    # add new point using dialog box
    def OnAddPoint(self,evt):
        import addPoint
        # this only calls up the warning dialog the actual deletion
        # is handled in the OnLeftSelect function call and RemoveLine
        dlg = addPoint.addNewPoint(self)
        # dlg.ShowModal()
    ...
    def __init__(self):
        ...
        # btnsizer.Add(self.pseudo, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
        # btnsizer.Add(xit, 0, wx.ALL|wx.ALIGN_CENTER, 5)
        sizerR.Add(btnsizer,0,wx.ALIGN_CENTER_HORIZONTAL)
