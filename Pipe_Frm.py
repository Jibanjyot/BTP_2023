...
class PipeFrm(wx.Frame):
    ...
    def InitUI(self, lbl):
        ...
        # self.nb.AddPage(ManVlv1(self.nb),'Ball, Butterfly, Plug, Globe Valves')
        ...
        self.nb.AddPage(ManVlv1(self.nb),'Future')
        self.nb.AddPage(ManVlv2(self.nb), 'Future')
        self.nb.AddPage(ChkVlv(self.nb), 'Future')
        self.nb.AddPage(Fitting(self.nb), 'Future')
        self.nb.AddPage(WldElb(self.nb), 'Future')
        self.nb.AddPage(EntExt(self.nb), 'Future')
        self.Bind(wx.EVT_NOTEBOOK_PAGE_CHANGED, self.OnPageChanged)
        # self.Bind(wx.EVT_NOTEBOOK_PAGE_CHANGING, self.OnBeforePgChg)
...
class General(wx.Panel):
    def __init__(self, parent):
        ...
        self.unt1 = wx.Choice(self, choices=chcs_2)    
...
#        self.info1 = wx.TextCtrl(self, value='', style=wx.TE_RIGHT)
        ...
        self.prv_chk = wx.CheckBox(self, id=1, label='',
                                   style=wx.ALIGN_RIGHT)
        self.bpv_chk = wx.CheckBox(self, id=2, label='',
                                   style=wx.ALIGN_RIGHT)
